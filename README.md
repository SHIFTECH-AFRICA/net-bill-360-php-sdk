...
|---|---|---|---|---------------------------------------------------------------------------------------|
| **1.x** | ✅ Active | `shiftechafrica/net-bill-360-php-sdk` | `NetBill360\NetBill360ServiceProvider` | [v1.1.7](https://github.com/SHIFTECH-AFRICA/net-bill-360-php-sdk/releases/tag/v1.1.7) |
